package io.github.hummel009.minecraft.got.common.world.structure.essos.qohor;
...
public class GOTStructureQohorBazaar extends GOTStructureEssosBazaar {
	...
	public static class Baker extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorBaker(world);
	...
	public static class Blacksmith extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorBlacksmith(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Brewer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeMug(world, random, 2, 2, 0, 1, GOTFoods.DEFAULT_DRINK);
			GOTEntityNPC trader = new GOTEntityQohorBrewer(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Butcher extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorButcher(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Farmer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorFarmer(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Fish extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorFishmonger(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Florist extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorFlorist(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Goldsmith extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			setBlockAndMetadata(world, random.nextBoolean() ? -1 : 1, 2, 1, GOTBlocks.birdCage, 2);
			GOTEntityNPC trader = new GOTEntityQohorGoldsmith(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Lumber extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorLumberman(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Mason extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityQohorMason(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Miner extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, 1, 2, 1, 2, getRandWeaponItem(random));
			GOTEntityNPC trader = new GOTEntityQohorMiner(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
