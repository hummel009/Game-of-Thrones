package io.github.hummel009.minecraft.got.common.world.structure.essos.ghiscar;
...
public class GOTStructureGhiscarBazaar extends GOTStructureEssosBazaar {
	...
	public static class Baker extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarBaker(world);
	...
	public static class Blacksmith extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarBlacksmith(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Brewer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeMug(world, random, 2, 2, 0, 1, GOTFoods.DEFAULT_DRINK);
			GOTEntityNPC trader = new GOTEntityGhiscarBrewer(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Butcher extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarButcher(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Farmer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarSlaver(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Fish extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarFishmonger(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Florist extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarFlorist(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Goldsmith extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			setBlockAndMetadata(world, random.nextBoolean() ? -1 : 1, 2, 1, GOTBlocks.birdCage, 2);
			GOTEntityNPC trader = new GOTEntityGhiscarGoldsmith(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Lumber extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarLumberman(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Mason extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityGhiscarMason(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
	...
	public static class Miner extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, 1, 2, 1, 2, getRandWeaponItem(random));
			GOTEntityNPC trader = new GOTEntityGhiscarMiner(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	}
