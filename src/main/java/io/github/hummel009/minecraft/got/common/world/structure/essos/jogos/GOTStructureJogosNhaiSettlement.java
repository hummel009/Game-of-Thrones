...
public class GOTStructureJogosNhaiSettlement extends GOTStructureBaseSettlement {
	...
	public GOTStructureJogosNhaiSettlement(GOTBiome biome, float f) {
		super(biome);
		spawnChance = f;
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance {
		...
		public void addSettlementStructures(Random random) {
			...
			while (turn < 1.0f) {
				...
				addStructure(new GOTStructureJogosNhaiTent(false), i, k, r);
			}
		}
		...
		private static class StructureRespawner1 extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityJogosNhaiMan.class);
		...
		private static class StructureRespawner2 extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityJogosNhaiMan.class);
				spawner.setSpawnClass2(GOTEntityJogosNhaiArcher.class);
