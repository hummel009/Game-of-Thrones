...
import io.github.hummel009.minecraft.got.common.entity.essos.yi_ti.GOTEntityYiTiBartender;
...
public class GOTStructureYiTiTavern extends GOTStructureYiTiBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < men; ++l) {
			GOTEntityNPC npc = new GOTEntityYiTiMan(world);
			spawnNPCAndSetHome(npc, world, 2, 1, 0, 16);
		}
		return true;
	}
