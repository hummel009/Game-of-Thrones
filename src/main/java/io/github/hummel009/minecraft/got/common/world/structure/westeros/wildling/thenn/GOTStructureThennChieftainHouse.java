package io.github.hummel009.minecraft.got.common.world.structure.westeros.wildling.thenn;
...
import io.github.hummel009.minecraft.got.common.entity.westeros.wildling.thenn.GOTEntityThennChieftain;
...
public class GOTStructureThennChieftainHouse extends GOTStructureBase {

	public GOTStructureThennChieftainHouse(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeWallBanner(world, 0, 5, -5, GOTItemBanner.BannerType.THENN, 2);
		placeWallBanner(world, -2, 5, -5, GOTItemBanner.BannerType.THENN, 2);
		placeWallBanner(world, 2, 5, -5, GOTItemBanner.BannerType.THENN, 2);
		for (i12 = -3; i12 <= 3; ++i12) {
		...
		placeWallBanner(world, -3, 3, 0, GOTItemBanner.BannerType.THENN, 1);
		setBlockAndMetadata(world, 2, 5, 0, Blocks.torch, 1);
		placeWallBanner(world, 3, 3, 0, GOTItemBanner.BannerType.THENN, 3);
		for (k12 = -3; k12 <= -1; ++k12) {
		...
		GOTEntityNPC chieftain = new GOTEntityThennChieftain(world);
