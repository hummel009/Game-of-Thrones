package io.github.hummel009.minecraft.got.common.world.structure.essos.jogos;
...
import io.github.hummel009.minecraft.got.common.entity.animal.GOTEntityCamel;
import io.github.hummel009.minecraft.got.common.entity.essos.jogos.GOTEntityJogosNhaiChieftain;
...
public class GOTStructureJogosNhaiChieftainTent extends GOTStructureJogosNhaiBase {
	public GOTStructureJogosNhaiChieftainTent(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 6, 1, 4, bedBlock, 0);
		setBlockAndMetadata(world, 6, 1, 5, bedBlock, 8);
		placeChest(world, random, -11, 1, 0, GOTBlocks.chestBasket, 4, GOTChestContents.JOGOS_NHAI);
		placeChest(world, random, 11, 1, 0, GOTBlocks.chestBasket, 5, GOTChestContents.JOGOS_NHAI);
		...
		placePlateWithCertainty(world, random, 6, 2, -5, GOTBlocks.ceramicPlate, GOTFoods.DEFAULT);
		placeMug(world, random, 4, 2, -5, 2, GOTFoods.DEFAULT_DRINK);
		placeWallBanner(world, 0, 3, 7, GOTItemBanner.BannerType.JOGOS_NHAI, 2);
		placeWallBanner(world, -5, 4, 6, GOTItemBanner.BannerType.JOGOS_NHAI, 2);
		placeWallBanner(world, 5, 4, 6, GOTItemBanner.BannerType.JOGOS_NHAI, 2);
		placeWallBanner(world, -12, 4, 0, GOTItemBanner.BannerType.JOGOS_NHAI, 1);
		placeWallBanner(world, 12, 4, 0, GOTItemBanner.BannerType.JOGOS_NHAI, 3);
		placeWallBanner(world, 0, 5, -8, GOTItemBanner.BannerType.JOGOS_NHAI, 2);
		setBlockAndMetadata(world, -1, 4, -9, Blocks.skull, 2);
		setBlockAndMetadata(world, 1, 4, -9, Blocks.skull, 2);
		GOTEntityNPC chief = new GOTEntityJogosNhaiChieftain(world);
		spawnNPCAndSetHome(chief, world, 0, 1, 0, 8);
		int warriors = 2 + random.nextInt(2);
		for (int l = 0; l < warriors; ++l) {
			GOTEntityNPC warrior = new GOTEntityJogosNhaiMan(world);
