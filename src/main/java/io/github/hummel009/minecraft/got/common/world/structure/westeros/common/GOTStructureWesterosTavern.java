...
import io.github.hummel009.minecraft.got.common.entity.other.*;
...
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.trader.GOTEntityHotPie;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.trader.GOTEntityPetyrBaelish;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.warrior.GOTEntityPodrickPayne;
...
public class GOTStructureWesterosTavern extends GOTStructureWesterosBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeChest(world, random, -3, 0, 8, 5, getChestContents());
		for (k12 = 6; k12 <= 8; ++k12) {
		...
		for (i13 = -7; i13 <= -3; ++i13) {
			for (k1 = 10; k1 <= 14; ++k1) {
				...
				setBlockAndMetadata(world, i13, 9, k1, roofSlabBlock, roofSlabMeta | 8);
			}
		}
		...
		for (i13 = -2; i13 <= 6; ++i13) {
			...
			if (i2 == 2) {
				...
				for (k16 = 0; k16 <= 2; ++k16) {
					setBlockAndMetadata(world, i13, 9, k16, roofSlabBlock, roofSlabMeta | 8);
				}
			...
			if (i2 == 0) {
				...
				setBlockAndMetadata(world, i13, 8, 2, Blocks.torch, 4);
				setBlockAndMetadata(world, i13, 6, 11, doorBlock, 1);
				setBlockAndMetadata(world, i13, 7, 11, doorBlock, 8);
				setBlockAndMetadata(world, i13, 8, 12, Blocks.torch, 3);
			}
			if (i2 == 3) {
		...
		for (k12 = 5; k12 <= 9; ++k12) {
			...
			if (k2 == 1) {
				...
				for (i12 = -7; i12 <= -5; ++i12) {
					setBlockAndMetadata(world, i12, 9, k12, roofSlabBlock, roofSlabMeta | 8);
				}
			...
			if (k2 == 3) {
				...
				setBlockAndMetadata(world, -5, 8, k12, Blocks.torch, 1);
