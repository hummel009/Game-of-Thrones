...
public class GOTStructureAsshaiHouse extends GOTStructureAsshaiBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (i1 = -5; i1 <= 4; ++i1) {
			for (int k14 = -7; k14 <= 5; ++k14) {
				...
				if (k14 == -7) {
					if (i2 == 4 || i2 == 2) {
						for (j13 = 1; j13 <= 3; ++j13) {
							setBlockAndMetadata(world, i1, j13, -7, pillarBlock, pillarMeta);
						}
						continue;
					}
					for (j13 = 1; j13 <= 3; ++j13) {
		...
		setBlockAndMetadata(world, 0, 3, -6, GOTBlocks.chandelier, 6);
		...
		setBlockAndMetadata(world, 0, 3, 1, GOTBlocks.chandelier, 6);
		for (k1 = 0; k1 <= 1; ++k1) {
		...
		setBlockAndMetadata(world, 0, 8, -2, GOTBlocks.chandelier, 6);
		setBlockAndMetadata(world, 0, 9, 3, brick2Block, brick2Meta);
		setBlockAndMetadata(world, 0, 8, 3, GOTBlocks.chandelier, 6);
		...
		GOTEntityNPC male = new GOTEntityAsshaiMan(world);
		...
		GOTEntityNPC female = new GOTEntityAsshaiMan(world);
		...
		GOTEntityNPC child = new GOTEntityAsshaiMan(world);
