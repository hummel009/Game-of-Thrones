	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		for (int l = 0; l < sections; ++l) {
			...
			if (l > 0) {
				...
				placeWallBanner(world, 0, sectionBase + 6, -radius, GOTItemBanner.BannerType.ASSHAI, 2);
				for (i13 = -5; i13 <= 5; ++i13) {
		...
		spawnNPCAndSetHome(new GOTEntityAsshaiCaptain(world), world, 0, topHeight + 1, 0, 16);
