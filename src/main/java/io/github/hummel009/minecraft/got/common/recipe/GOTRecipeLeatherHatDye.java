...
import io.github.hummel009.minecraft.got.common.item.other.GOTItemDye;
	...
	public ItemStack getCraftingResult(InventoryCrafting inv) {
		...
		for (int i = 0; i < inv.getSizeInventory(); ++i) {
			...
			if (itemstack.getItem() == GOTItems.leatherHat) {
				...
				hat = itemstack.copy();
				hat.stackSize = 1;
				if (!GOTItemLeatherHat.isHatDyed(hat)) {
					continue;
				}
				int hatColor = GOTItemLeatherHat.getHatColor(hat);
		...
		GOTItemLeatherHat.setHatColor(hat, color);
		return hat;
	}
