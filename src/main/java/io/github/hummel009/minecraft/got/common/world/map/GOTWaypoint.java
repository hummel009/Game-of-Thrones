...
import io.github.hummel009.minecraft.got.common.world.genlayer.GOTGenLayerWorld;
...
public enum GOTWaypoint implements GOTAbstractWaypoint {
	...
	ADAKHAKILEKI(Region.ESSOS_SEPARATOR, GOTFaction.NEUTRAL, 2827, 1857),
	AEGON(Region.OCEAN, GOTFaction.NEUTRAL, 20, 3055),
	...
	AQUOS_DHAEN(Region.VALYRIA, GOTFaction.NEUTRAL, 1906, 2378),
	...
	BAYASABHAD(Region.ESSOS_SEPARATOR, GOTFaction.NEUTRAL, 3098, 2074),
	...
	BLOODSTONE(Arrays.asList(Region.DORNE, Region.SOUTHERN_FREE_CITIES), GOTFaction.NEUTRAL, 1044, 1924),
	...
	DRACONYS(Region.VALYRIA, GOTFaction.NEUTRAL, 1707, 2331),
	...
	EURON(Region.OCEAN, GOTFaction.NEUTRAL, 3065, 3065, true),
	...
	FOURTEEN_FLAMES(Region.VALYRIA, GOTFaction.NEUTRAL, 1714, 2284),
	...
	GREY_GALLOWS(Arrays.asList(Region.DORNE, Region.SOUTHERN_FREE_CITIES), GOTFaction.NEUTRAL, 1085, 1951),
	...
	HOJDBAATAR(Region.JOGOS_NHAI, GOTFaction.JOGOS_NHAI, 3655, 1654),
	...
	KAYAKAYANAYA(Arrays.asList(Region.ESSOS_SEPARATOR, Region.JOGOS_NHAI), GOTFaction.NEUTRAL, 3069, 1603),
	...
	MHYSA_FAER(Region.VALYRIA, GOTFaction.NEUTRAL, 1761, 2472),
	...
	OROS(Region.VALYRIA, GOTFaction.NEUTRAL, 1842, 2250),
	...
	RAENYS(Region.OCEAN, GOTFaction.NEUTRAL, 15, 3064),
	...
	RHYOS(Region.VALYRIA, GOTFaction.NEUTRAL, 1737, 2182),
	...
	SAMYRIANA(Region.ESSOS_SEPARATOR, GOTFaction.NEUTRAL, 3026, 1850),
	...
	TELYRIA(Region.VALYRIA, GOTFaction.NEUTRAL, 1877, 2168),
	...
	TORTURERS_DEEP(Arrays.asList(Region.DORNE, Region.SOUTHERN_FREE_CITIES), GOTFaction.NEUTRAL, 1082, 1990),
	...
	TYRIA(Region.VALYRIA, GOTFaction.NEUTRAL, 1819, 2303),
	...
	VAES_JINI(Arrays.asList(Region.IBBEN_COLONY, Region.DOTHRAKI, Region.ESSOS_SEPARATOR), GOTFaction.NEUTRAL, 2839, 1822),
	...
	VISENYA(Region.OCEAN, GOTFaction.NEUTRAL, 26, 3063),
	...
	private boolean isConquered(EntityPlayer entityplayer) {
		...
		return oathFac != null && zone.getConquestStrength(oathFac, world) >= 500.0f;
	}
	...
	public boolean isConquestUnlockable(EntityPlayer entityplayer) {
		...
		GOTConquestZone zone = GOTConquestGrid.getZoneByWorldCoords(coordX, coordZ);
		GOTFaction oathFac = pd.getOathFaction();
		return oathFac != null && oathFac.isBadRelation(faction) && GOTConquestGrid.getConquestEffectIn(world, zone, oathFac) == GOTConquestGrid.ConquestEffective.EFFECTIVE;
	}
