package io.github.hummel009.minecraft.got.common.world.map;

import io.github.hummel009.minecraft.got.common.entity.essos.legendary.GOTEntityMissandei;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.boss.GOTEntityAsshaiArchmag;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.captain.*;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.mercenary.GOTEntityDaarioNaharis;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.mercenary.GOTEntityGreyWorm;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.quest.GOTEntityBuGai;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.quest.GOTEntityDaenerysTargaryen;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.quest.GOTEntityMellario;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.trader.GOTEntityIllyrioMopatis;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.trader.GOTEntityMoqorro;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.trader.GOTEntityTychoNestoris;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.trader.GOTEntityXaroXhoanDaxos;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.warrior.GOTEntityJonConnington;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.warrior.GOTEntityJorahMormont;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.warrior.GOTEntityTugarKhan;
import io.github.hummel009.minecraft.got.common.entity.essos.legendary.warrior.GOTEntityYoungGriff;
import io.github.hummel009.minecraft.got.common.entity.other.GOTEntityHummel009;
...
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.captain.*;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.deco.*;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.mercenary.GOTEntityAndrikTheUnsmilling;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.mercenary.GOTEntityDagmer;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.quest.*;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.reborn.GOTEntityBericDondarrion;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.reborn.GOTEntityGregorClegane;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.reborn.GOTEntityTheonGreyjoy;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.trader.*;
import io.github.hummel009.minecraft.got.common.entity.westeros.legendary.warrior.*;
...
import io.github.hummel009.minecraft.got.common.world.feature.GOTWorldGenPartyTrees;
import io.github.hummel009.minecraft.got.common.world.structure.essos.asshai.GOTStructureAsshaiSettlement;
...
import io.github.hummel009.minecraft.got.common.world.structure.essos.ghiscar.GOTStructureGhiscarSettlement;
...
import io.github.hummel009.minecraft.got.common.world.structure.essos.lys.GOTStructureLysSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.essos.mossovy.GOTStructureMossovySettlement;
import io.github.hummel009.minecraft.got.common.world.structure.essos.myr.GOTStructureMyrSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.essos.norvos.GOTStructureNorvosSettlement;
...
import io.github.hummel009.minecraft.got.common.world.structure.essos.tyrosh.GOTStructureTyroshSettlement;
...
import io.github.hummel009.minecraft.got.common.world.structure.westeros.crownlands.GOTStructureCrownlandsSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.dorne.GOTStructureDorneSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.dragonstone.GOTStructureDragonstoneSettlement;
...
import io.github.hummel009.minecraft.got.common.world.structure.westeros.north.GOTStructureNorthSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.reach.GOTStructureReachSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.riverlands.GOTStructureRiverlandsSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.stormlands.GOTStructureStormlandsSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.westerlands.GOTStructureWesterlandsSettlement;
import io.github.hummel009.minecraft.got.common.world.structure.westeros.wildling.GOTStructureWildlingSettlement;
import net.minecraft.world.World;
import net.minecraft.world.gen.feature.WorldGenerator;

import java.util.*;

import static io.github.hummel009.minecraft.got.common.world.map.GOTCoordConverter.toEssosTownGate;
...
public class GOTFixer {
	...
	public static void addSpecialLocations(World world, Random random, int i, int k) {
		...
		if (GOTFixedStructures.fixedAt(i, k, GOTWaypoint.WINTERFELL.info(-0.45, -0.05, Dir.WEST))) {
	...
	public static void onInit() {
		...
		wps.add(GOTWaypoint.ANTLERS.info(0.05, -0.5));
		...
		wps.add(GOTWaypoint.BLACKMONT.info(0.35, 0, Dir.EAST));
		...
		wps.add(GOTWaypoint.APPLETON.info(-0.05, -0.5));
		wps.add(GOTWaypoint.ASHFORD);
		wps.add(GOTWaypoint.BANDALLON);
		wps.add(GOTWaypoint.GRASSY_VALE);
		wps.add(GOTWaypoint.GRIMSTON);
		wps.add(GOTWaypoint.HAMMERHAL.info(0.45, -0.05, Dir.EAST));
		wps.add(GOTWaypoint.RED_LAKE.info(0, 0.4, Dir.SOUTH));
		wps.add(GOTWaypoint.SOUTHSHIELD);
		wps.add(GOTWaypoint.UPLANDS);
		wps.add(GOTWaypoint.HOLYHALL.info(0.4, 0, Dir.EAST));
		wps.add(GOTWaypoint.HONEYHOLT);
		wps.add(GOTWaypoint.IVY_HALL.info(0, 0.35, Dir.SOUTH));
		...
		wps.add(GOTWaypoint.GARNETGROVE.info(-0.35, 0, Dir.WEST));
		wps.add(GOTWaypoint.LORD_HEWETTS_TOWN);
		wps.add(GOTWaypoint.OLD_OAK.info(0, 0.35, Dir.SOUTH));
		wps.add(GOTWaypoint.SUNHOUSE.info(0, 0.35, Dir.SOUTH));
		wps.add(GOTWaypoint.WHITEGROVE.info(-0.45, -0.05, Dir.WEST));
		...
		wps.add(GOTWaypoint.ASHFORD);
		wps.add(GOTWaypoint.LORD_HEWETTS_TOWN);
		wps.add(GOTWaypoint.SMITHYTON.info(0, 0.8, Dir.SOUTH));
		wps.add(GOTWaypoint.VINETOWN);
		wps.add(GOTWaypoint.RYAMSPORT);
		wps.add(GOTWaypoint.TUMBLETON.info(0.1, -0.95));
		...
		wps.add(GOTWaypoint.HARROWAY.info(-0.1, 0.9, Dir.SOUTH));
		...
		wps.add(GOTWaypoint.HOLLARD_CASTLE.info(0.2, 0));
		wps.add(GOTWaypoint.OLDSTONES.info(0, 0.3));
		wps.add(GOTWaypoint.SUMMERHALL.info(-0.2, -0.15));
		...
		wps.add(GOTWaypoint.BLACKHAVEN.info(-0.4, 0, Dir.WEST));
		wps.add(GOTWaypoint.BRONZEGATE.info(0.05, -0.5));
		...
		wps.add(GOTWaypoint.PARCHMENTS.info(0, -0.35));
		wps.add(GOTWaypoint.PODDINGFIELD.info(0, -0.4));
		...
		wps.add(GOTWaypoint.NIGHTSONG.info(0, -0.4));
		...
		wps.add(GOTWaypoint.THREE_TOWERS.info(-0.4, -0.4, Dir.WEST));
		wps.add(GOTWaypoint.THREE_TOWERS.info(-0.4, 0, Dir.WEST));
		wps.add(GOTWaypoint.THREE_TOWERS.info(-0.4, 0.4, Dir.WEST));
		...
		}.type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.HIGH_HERMITAGE.info(0.4, 0, Dir.EAST));
		...
		}.type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.KARHOLD.info(0.35, 0, Dir.EAST));
		...
		}.type(GOTStructureReachSettlement.Type.TOWN, 6), GOTWaypoint.OLDTOWN.info(-1.0, -0.2, Dir.WEST));
		...
		}.type(GOTStructureReachSettlement.Type.FORT, 3), GOTWaypoint.RING.info(0, -0.35));
		...
		}.type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.RYSWELLS_CASTLE.info(-0.45, 0.05, Dir.WEST));
		...
		}.type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.SKYREACH.info(0, 0.35, Dir.SOUTH));
		...
		}.type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.TORRHENS_SQUARE.info(-0.35, 0, Dir.WEST));
		...
		}.type(GOTStructureNorthSettlement.Type.FORT, 3), GOTWaypoint.WINTERFELL.info(-0.45, -0.05, Dir.WEST));
		...
		}.type(GOTStructureDorneSettlement.Type.FORT, 3), GOTWaypoint.YRONWOOD.info(0.35, 0, Dir.EAST));
