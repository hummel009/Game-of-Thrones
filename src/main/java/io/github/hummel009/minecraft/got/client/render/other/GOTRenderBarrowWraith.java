...
import io.github.hummel009.minecraft.got.client.model.GOTModelWight;
...
public class GOTRenderBarrowWraith extends GOTRenderBiped {
	...
	public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
		...
		GOTEntityBarrowWraith wight = (GOTEntityBarrowWraith) entity;
