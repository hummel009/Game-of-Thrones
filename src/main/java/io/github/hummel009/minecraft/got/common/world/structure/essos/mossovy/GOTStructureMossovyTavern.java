...
import io.github.hummel009.minecraft.got.common.entity.essos.mossovy.GOTEntityMossovyBartender;
...
public class GOTStructureMossovyTavern extends GOTStructureMossovyBase {
	private String[] tavernNameSign;

	public GOTStructureMossovyTavern(boolean flag) {
		super(flag);
	}
