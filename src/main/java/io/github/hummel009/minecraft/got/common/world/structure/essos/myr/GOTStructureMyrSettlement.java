...
import io.github.hummel009.minecraft.got.common.world.structure.essos.common.GOTStructureEssosVillageFence;
import io.github.hummel009.minecraft.got.common.world.structure.essos.common.GOTStructureEssosVillagePost;
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance {
		...
		private static class StructureRespawner extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityMyrSoldier.class);
		...
		private static class StructureRespawner1 extends GOTStructureNPCRespawner {
			...
			@Override
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityMyrMan.class);
		...
		private static class StructureRespawner2 extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityMyrSoldier.class);
				spawner.setSpawnClass2(GOTEntityMyrSoldierArcher.class);
