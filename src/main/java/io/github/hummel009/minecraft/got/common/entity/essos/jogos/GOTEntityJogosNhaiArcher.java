package io.github.hummel009.minecraft.got.common.entity.essos.jogos;
...
public class GOTEntityJogosNhaiArcher extends GOTEntityJogosNhaiMan {
	@SuppressWarnings({"WeakerAccess", "unused"})
	public GOTEntityJogosNhaiArcher(World world) {
		super(world);
	}
