...
import io.github.hummel009.minecraft.got.common.entity.other.inanimate.GOTEntityCargocart;
import io.github.hummel009.minecraft.got.common.entity.other.inanimate.GOTEntityCart;
import net.minecraft.client.model.ModelBase;
import net.minecraft.client.model.ModelRenderer;
import net.minecraft.entity.Entity;

public class GOTModelCargocart extends ModelBase {
	private final ModelRenderer boardb = new ModelRenderer(this, 0, 0).setTextureSize(128, 128);
	private final ModelRenderer cargo;
	private final ModelRenderer cargo1;
	private final ModelRenderer cargo2;
	private final ModelRenderer cargo3;
	...
	public GOTModelCargocart() {
		...
		ModelRenderer boardf = new ModelRenderer(this, 0, 30).setTextureSize(128, 128);
		boardf.addBox(-12.0f, 7.0f, -14.5f, 24, 10, 1);
		boardb.addChild(boardf);
		ModelRenderer stickb = new ModelRenderer(this, 0, 4).setTextureSize(128, 128);
		stickb.addBox(-12.0f, 6.0f, 14.5f, 2, 11, 1);
		stickb.addBox(10.0f, 6.0f, 14.5f, 2, 11, 1);
		boardb.addChild(stickb);
		ModelRenderer boardsl = new ModelRenderer(this, 0, 74).setTextureSize(128, 128);
		boardsl.addBox(-12.0f, 9.0f, -13.5f, 1, 3, 28);
		boardsl.addBox(-12.0f, 14.0f, -13.5f, 1, 3, 28);
		boardb.addChild(boardsl);
		ModelRenderer boardsr = new ModelRenderer(this, 0, 74).setTextureSize(128, 128);
		boardsr.mirror = true;
