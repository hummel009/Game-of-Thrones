...
import io.github.hummel009.minecraft.got.common.entity.essos.dothraki.GOTEntityDothrakiChieftain;
...
public class GOTStructureDothrakiChieftainTent extends GOTStructureDothrakiBase {
	public GOTStructureDothrakiChieftainTent(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 1, 4, -9, Blocks.skull, 2);
		GOTEntityNPC chief = new GOTEntityDothrakiChieftain(world);
