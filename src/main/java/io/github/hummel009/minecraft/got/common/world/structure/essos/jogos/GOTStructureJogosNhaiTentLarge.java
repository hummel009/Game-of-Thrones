...
public class GOTStructureJogosNhaiTentLarge extends GOTStructureJogosNhaiBase {
	public GOTStructureJogosNhaiTentLarge(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeChest(world, random, -4, 1, -5, GOTBlocks.chestBasket, 3, GOTChestContents.JOGOS_NHAI);
		placeWallBanner(world, 0, 5, 7, GOTItemBanner.BannerType.JOGOS_NHAI, 2);
