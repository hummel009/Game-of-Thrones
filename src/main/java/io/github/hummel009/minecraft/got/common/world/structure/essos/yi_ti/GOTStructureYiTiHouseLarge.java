...
public class GOTStructureYiTiHouseLarge extends GOTStructureYiTiBaseTown {
	public GOTStructureYiTiHouseLarge(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		setBlockAndMetadata(world, 0, 6, -7, GOTBlocks.reedBars, 0);
		for (int i1221 : new int[]{-5, 5}) {
			setBlockAndMetadata(world, i1221, 6, -2, GOTBlocks.reedBars, 0);
			setBlockAndMetadata(world, i1221, 6, 2, GOTBlocks.reedBars, 0);
		}
		...
		for (k14 = -7; k14 <= -5; ++k14) {
			...
			if (random.nextBoolean()) {
				placePlate(world, random, -5, 2, k14, plateBlock, GOTFoods.DEFAULT);
			} else {
				placeMug(world, random, -5, 2, k14, 3, GOTFoods.DEFAULT_DRINK);
			}
		...
		placeBarrel(world, random, -2, 2, 3, 5, GOTFoods.DEFAULT_DRINK);
		setBlockAndMetadata(world, 2, 1, 3, plankStairBlock, 4);
		placeBarrel(world, random, 2, 2, 3, 4, GOTFoods.DEFAULT_DRINK);
		setBlockAndMetadata(world, -2, 3, 4, GOTBlocks.chandelier, 2);
		setBlockAndMetadata(world, 2, 3, 4, GOTBlocks.chandelier, 2);
		...
		setBlockAndMetadata(world, 0, 0, 7, GOTBlocks.hearth, 0);
		setBlockAndMetadata(world, 0, 1, 7, barsBlock, 0);
		setBlockAndMetadata(world, 0, 2, 7, Blocks.furnace, 2);
		setBlockAndMetadata(world, 0, 0, 8, GOTBlocks.hearth, 0);
		...
		for (i14 = 3; i14 <= 5; ++i14) {
			if (random.nextBoolean()) {
				placePlate(world, random, i14, 2, 7, plateBlock, GOTFoods.DEFAULT);
				continue;
			}
			placeMug(world, random, i14, 2, 7, 0, GOTFoods.DEFAULT_DRINK);
		}
		for (k14 = 5; k14 <= 6; ++k14) {
			if (random.nextBoolean()) {
				placePlate(world, random, 5, 2, k14, plateBlock, GOTFoods.DEFAULT);
		...
		setBlockAndMetadata(world, -2, 7, 4, GOTBlocks.chandelier, 2);
		setBlockAndMetadata(world, 2, 7, 4, GOTBlocks.chandelier, 2);
		...
		for (int i1221 : new int[]{-3, -1, 1, 3}) {
			...
			if (random.nextBoolean()) {
				placePlate(world, random, i1221, 6, -6, plateBlock, GOTFoods.DEFAULT);
				continue;
			}
