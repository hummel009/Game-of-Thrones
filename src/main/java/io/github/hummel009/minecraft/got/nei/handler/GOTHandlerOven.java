package io.github.hummel009.minecraft.got.nei.handler;
...
import io.github.hummel009.minecraft.got.client.gui.GOTGuiOven;
import io.github.hummel009.minecraft.got.common.tileentity.GOTTileEntityOven;
...
public class GOTHandlerOven extends TemplateRecipeHandler {
	...
	public void loadUsageRecipes(ItemStack ingredient) {
		...
		if (GOTTileEntityOven.isCookResultAcceptable(tmp)) {
