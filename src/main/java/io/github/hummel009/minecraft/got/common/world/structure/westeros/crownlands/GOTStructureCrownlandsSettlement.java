...
import io.github.hummel009.minecraft.got.common.entity.westeros.crownlands.GOTEntityCrownlandsAlchemist;
...
import io.github.hummel009.minecraft.got.common.world.structure.westeros.common.*;
...
public class GOTStructureCrownlandsSettlement extends GOTStructureBaseSettlement {
	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance {
		...
		private static GOTStructureBase getRandomHouse(Random random) {
			...
			return new GOTStructureCrownlandsHouseSmall(false);
		}
		...
		private void setupCastle() {
			...
			addStructure(new GOTStructureCrownlandsWatchtower(false), -23, -33, 2, true);
			addStructure(new GOTStructureCrownlandsWatchtower(false), 23, -33, 2, true);
			...
			addStructure(new GOTStructureCrownlandsWatchtower(false), -33, -23, 1, true);
			addStructure(new GOTStructureCrownlandsWatchtower(false), -33, 23, 1, true);
			...
			addStructure(new GOTStructureCrownlandsWatchtower(false), -23, 33, 0, true);
			addStructure(new GOTStructureCrownlandsWatchtower(false), 23, 33, 0, true);
			...
			addStructure(new GOTStructureCrownlandsWatchtower(false), 33, -23, 3, true);
			addStructure(new GOTStructureCrownlandsWatchtower(false), 33, 23, 3, true);
			...
			addStructure(new GOTStructureCrownlandsStables(false), -24, 2, 0);
			addStructure(new GOTStructureCrownlandsStables(false), -24, -2, 2);
			addStructure(new GOTStructureCrownlandsSmithy(false), 24, 1, 0);
			addStructure(new GOTStructureCrownlandsSmithy(false), 24, -1, 2);
			addStructure(new GOTStructureCrownlandsHouseLarge(false), -3, -25, 1);
			addStructure(new GOTStructureCrownlandsHouseLarge(false), 3, -25, 3);
			addStructure(new GOTStructureCrownlandsVillageFarm.Crops(false), -18, -21, 1);
			addStructure(new GOTStructureCrownlandsVillageFarm.Crops(false), 18, -21, 3);
		...
		private void setupKingsLanding(Random random) {
			...
			for (int k1 = -1; k1 <= 1; ++k1) {
				int houseZ = k1 * 12;
				if (k1 == 1) {
					addStructure(new GOTStructureCrownlandsHouseLarge(false), -houseX, houseZ, 1, true);
					addStructure(new GOTStructureCrownlandsHouseLarge(false), houseX, houseZ, 3, true);
				}
				if (k1 == 0) {
					continue;
				}
				addStructure(new GOTStructureCrownlandsHouseLarge(false), houseZ, houseX, 0, true);
				addStructure(new GOTStructureCrownlandsHouseLarge(false), houseZ, -houseX, 2, true);
			}
		...
		private void setupRedCastle() {
			...
			addStructure(new GOTStructureWesterosFortWall.Left(false).setGranite(), 11, -37, 0, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), -23, -33, 2, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), 23, -33, 2, true);
			addStructure(new GOTStructureWesterosFortGate(false).setGranite(), -37, 0, 3, true);
			addStructure(new GOTStructureWesterosFortWall.Left(false).setGranite(), -37, -11, 3, true);
			addStructure(new GOTStructureWesterosFortWall.Right(false).setGranite(), -37, 11, 3, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), -33, -23, 1, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), -33, 23, 1, true);
			addStructure(new GOTStructureWesterosFortGate(false).setGranite(), 0, 37, 2, true);
			addStructure(new GOTStructureWesterosFortWall.Left(false).setGranite(), -11, 37, 2, true);
			addStructure(new GOTStructureWesterosFortWall.Right(false).setGranite(), 11, 37, 2, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), -23, 33, 0, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), 23, 33, 0, true);
			addStructure(new GOTStructureWesterosFortGate(false).setGranite(), 37, 0, 1, true);
			addStructure(new GOTStructureWesterosFortWall.Right(false).setGranite(), 37, -11, 1, true);
			addStructure(new GOTStructureWesterosFortWall.Left(false).setGranite(), 37, 11, 1, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), 33, -23, 3, true);
			addStructure(new GOTStructureWesterosWatchtower(false).setGranite(), 33, 23, 3, true);
			addStructure(new GOTStructureWesterosFortWallCorner(false).setGranite(), -30, -30, 3);
			addStructure(new GOTStructureWesterosFortWallCorner(false).setGranite(), -30, 30, 2);
			addStructure(new GOTStructureWesterosFortWallCorner(false).setGranite(), 30, 30, 1);
			addStructure(new GOTStructureWesterosFortWallCorner(false).setGranite(), 30, -30, 2);
			addStructure(new GOTStructureWesterosStables(false).setGranite(), -24, 2, 0);
			addStructure(new GOTStructureWesterosStables(false).setGranite(), -24, -2, 2);
			addStructure(new GOTStructureWesterosSmithy(false).setGranite(), 24, 1, 0);
			addStructure(new GOTStructureWesterosSmithy(false).setGranite(), 24, -1, 2);
			addStructure(new GOTStructureWesterosStoneHouse(false).setGranite(), -3, -25, 1);
			addStructure(new GOTStructureWesterosStoneHouse(false).setGranite(), 3, -25, 3);
			addStructure(new GOTStructureWesterosVillageFarm.Tree(false).setGranite(), -18, -21, 1);
			addStructure(new GOTStructureWesterosVillageFarm.Tree(false).setGranite(), 18, -21, 3);
			addStructure(new GOTStructureWesterosWell(false).setGranite(), -12, 27, 1);
		...
		private void setupVillage(Random random) {
			...
			addStructure(new GOTStructureCrownlandsHouse(false), -21, 0, 1);
			addStructure(new GOTStructureCrownlandsHouse(false), 0, -21, 2);
			addStructure(new GOTStructureCrownlandsHouse(false), 21, 0, 3);
			addStructure(new GOTStructureCrownlandsTavern(false), 0, 21, 0);
			if (random.nextBoolean()) {
				if (random.nextBoolean()) {
					addStructure(GOTStructureCrownlandsMarketStall.getRandomStall(random, false), -9, -12, 1);
				}
				if (random.nextBoolean()) {
					addStructure(GOTStructureCrownlandsMarketStall.getRandomStall(random, false), 9, -12, 3);
				}
				if (random.nextBoolean()) {
					addStructure(GOTStructureCrownlandsMarketStall.getRandomStall(random, false), -9, 12, 1);
				}
		...
		private static class StructureRespawner1 extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityWesterlandsSoldier.class);
		...
		private static class StructureRespawner3 extends GOTStructureNPCRespawner {
			...
			@Override
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityCrownlandsAlchemist.class);
		...
		private static class StructureRespawner4 extends GOTStructureNPCRespawner {
			...
			@Override
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityCrownlandsMan.class);
