...
import io.github.hummel009.minecraft.got.common.network.GOTPacketMountControl;
import io.github.hummel009.minecraft.got.common.network.GOTPacketMountControlServerEnforce;
import io.github.hummel009.minecraft.got.core.GOTReplacedMethods;
...
public class GOTMountFunctions {
	...
	public static boolean isMountControllable(Entity mount) {
		return mount instanceof EntityHorse && ((EntityHorse) mount).isTame() || mount instanceof GOTEntitySpiderBase && ((GOTEntitySpiderBase) mount).isNPCTamed();
	}
