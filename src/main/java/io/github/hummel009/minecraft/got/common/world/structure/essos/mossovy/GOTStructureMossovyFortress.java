...
import io.github.hummel009.minecraft.got.common.entity.essos.mossovy.GOTEntityMossovyBlacksmith;
...
public class GOTStructureMossovyFortress extends GOTStructureMossovyBase {
	public GOTStructureMossovyFortress(boolean flag) {
		super(flag);
	}
