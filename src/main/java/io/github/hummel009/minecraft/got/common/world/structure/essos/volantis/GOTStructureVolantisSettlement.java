	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance {
		...
		private void setupTown() {
			...
			for (l = 0; l <= 3; ++l) {
				...
				k = -7;
				r = 2;
				addStructure(new GOTStructureVolantisHouseLarge(false), i, k, r, true);
		...
		private void setupVillage(Random random) {
			...
			addStructure(new GOTStructureVolantisHouseLarge(false), -3, -rSquareEdge, 2, true);
			addStructure(new GOTStructureVolantisHouseLarge(false), -rSquareEdge, 3, 1, true);
			addStructure(new GOTStructureVolantisHouseLarge(false), rSquareEdge, -3, 3, true);
			int backFenceX = 0;
		...
		private static class StructureRespawner1 extends GOTStructureNPCRespawner {
			...
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityVolantisMan.class);
		...
		private static class StructureRespawner2 extends GOTStructureNPCRespawner {
			...
			@Override
			public void setupRespawner(GOTEntityNPCRespawner spawner) {
				spawner.setSpawnClass1(GOTEntityVolantisSoldier.class);
				spawner.setSpawnClass2(GOTEntityVolantisSoldierArcher.class);
