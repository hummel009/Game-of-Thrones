...
public class GOTStructureSummerHouse extends GOTStructureSummerBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		if (!isRuined()) {
			...
			placeMug(world, random, 1, 2, 4, 0, GOTFoods.DEFAULT_DRINK);
			GOTEntityNPC male = new GOTEntitySummerMan(world);
			...
			GOTEntityNPC female = new GOTEntitySummerMan(world);
			...
			GOTEntityNPC child = new GOTEntitySummerMan(world);
