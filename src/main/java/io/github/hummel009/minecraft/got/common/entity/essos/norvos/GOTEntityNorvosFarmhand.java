package io.github.hummel009.minecraft.got.common.entity.essos.norvos;

import io.github.hummel009.minecraft.got.common.entity.ai.GOTEntityAIFarm;
...
public class GOTEntityNorvosFarmhand extends GOTEntityNorvosMan implements GOTFarmhand {
	private Item seedsItem;

	@SuppressWarnings({"WeakerAccess", "unused"})
	public GOTEntityNorvosFarmhand(World world) {
		super(world);
