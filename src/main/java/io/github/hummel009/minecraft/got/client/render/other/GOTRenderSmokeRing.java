...
import io.github.hummel009.minecraft.got.client.model.GOTModelSmokeShip;
import io.github.hummel009.minecraft.got.common.entity.other.inanimate.GOTEntitySmokeRing;
...
public class GOTRenderSmokeRing extends Render {
	...
	public ResourceLocation getEntityTexture(Entity entity) {
		return GOTClientProxy.PARTICLES_TEXTURE;
	}
}