package io.github.hummel009.minecraft.got.common.tileentity;

import io.github.hummel009.minecraft.got.common.block.other.GOTBlockBookshelfStorage;
import io.github.hummel009.minecraft.got.common.inventory.GOTContainerBookshelf;
import io.github.hummel009.minecraft.got.common.item.other.GOTItemModifierTemplate;
import io.github.hummel009.minecraft.got.common.item.other.GOTItemQuestBook;
...
public class GOTTileEntityBookshelf extends TileEntity implements IInventory {
	...
	public static boolean isBookItem(ItemStack itemstack) {
		if (itemstack != null) {
			...
			return item instanceof ItemBook || item instanceof ItemWritableBook || item instanceof ItemEditableBook || item instanceof GOTItemQuestBook || item instanceof ItemEnchantedBook || item instanceof ItemMapBase || item == Items.paper || item instanceof GOTItemModifierTemplate;
		}
		return false;
	}
