...
import io.github.hummel009.minecraft.got.common.entity.animal.GOTEntityFlamingo;
...
public class GOTModelFlamingo extends ModelBase {
	private final ModelRenderer head = new ModelRenderer(this, 8, 24);
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity entity) {
		...
		if (isChild) {
			...
			float fishing = pre + (cur - pre) * GOTTickHandlerClient.getRenderTick();
			if (cur > 160 + 20) {
