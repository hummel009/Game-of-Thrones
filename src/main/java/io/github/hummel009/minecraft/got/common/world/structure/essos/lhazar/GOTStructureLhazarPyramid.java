package io.github.hummel009.minecraft.got.common.world.structure.essos.lhazar;
...
public class GOTStructureLhazarPyramid extends GOTStructureLhazarBase {
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		addBlockMetaAliasOption("BRICK", GOTBlocks.brick1, 15);
		addBlockMetaAliasOption("BRICK", GOTBlocks.brick3, 11);
		addBlockAliasOption("BRICK_STAIR", GOTBlocks.stairsSandstoneBrick);
		addBlockAliasOption("BRICK_STAIR", GOTBlocks.stairsSandstoneBrickCracked);
		addBlockMetaAliasOption("BRICK_WALL", GOTBlocks.wallStone1, 15);
		addBlockMetaAliasOption("BRICK_WALL", GOTBlocks.wallStone3, 3);
		addBlockMetaAliasOption("PILLAR", GOTBlocks.pillar1, 5);
		addBlockMetaAliasOption("BRICK2", GOTBlocks.brick3, 13);
		addBlockMetaAliasOption("BRICK2", GOTBlocks.brick3, 14);
