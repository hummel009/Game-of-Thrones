	...
	public static class Instance extends GOTStructureBaseSettlement.AbstractInstance {
		...
		private void setupTown() {
			...
			for (l = 0; l <= 3; ++l) {
				...
				k = -7;
				r = 2;
				addStructure(new GOTStructurePentosHouseLarge(false), i, k, r, true);
		...
		private void setupVillage(Random random) {
			...
			addStructure(new GOTStructurePentosHouseLarge(false), -3, -rSquareEdge, 2, true);
			addStructure(new GOTStructurePentosHouseLarge(false), -rSquareEdge, 3, 1, true);
			addStructure(new GOTStructurePentosHouseLarge(false), rSquareEdge, -3, 3, true);
			int backFenceX = 0;
