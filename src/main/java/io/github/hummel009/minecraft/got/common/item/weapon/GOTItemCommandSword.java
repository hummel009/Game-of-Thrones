...
import io.github.hummel009.minecraft.got.common.network.GOTPacketLocationFX;
...
public class GOTItemCommandSword extends GOTItemSword implements GOTSquadrons.SquadronItem {
	...
	private static void command(EntityPlayer entityplayer, World world, ItemStack itemstack, MovingObjectPosition hitTarget) {
		...
		if (anyAttackCommanded) {
			...
			GOTPacketHandler.NETWORK_WRAPPER.sendTo(lOTRPacketLocationFX, (EntityPlayerMP) entityplayer);
		}
	}
