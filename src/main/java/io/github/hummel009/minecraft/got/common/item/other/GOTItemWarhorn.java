...
import io.github.hummel009.minecraft.got.common.inventory.GOTSlotReputationReward;
...
public class GOTItemWarhorn extends Item {
	...
	public int getColorFromItemStack(ItemStack itemstack, int pass) {
		if (pass == 0) {
			GOTFaction faction = getInvasionType(itemstack).getInvasionFaction();
