...
import io.github.hummel009.minecraft.got.common.entity.essos.jogos.GOTEntityJogosNhaiShaman;
...
public class GOTStructureJogosNhaiShamanTent extends GOTStructureJogosNhaiBase {
	private static final Class<? extends GOTStructureBase>[] STALLS = new Class[]{Mason.class, Brewer.class, Miner.class, Armourer.class};

	public GOTStructureJogosNhaiShamanTent(boolean flag) {
		super(flag);
	}
	...
	public static class Armourer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			GOTEntityNPC trader = new GOTEntityJogosNhaiShaman(world);
