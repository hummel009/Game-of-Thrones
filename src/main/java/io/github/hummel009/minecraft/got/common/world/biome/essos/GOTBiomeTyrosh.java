...
import io.github.hummel009.minecraft.got.common.world.structure.essos.tyrosh.GOTStructureTyroshFortress;
...
public class GOTBiomeTyrosh extends GOTBiomeEssosBase {
	public GOTBiomeTyrosh(int i, boolean major) {
		...
		c0.add(GOTBiomeSpawnList.entry(GOTSpawnList.TYROSH_CONQUEST, 4).setSpawnChance(SPAWN));
		c0.add(GOTBiomeSpawnList.entry(GOTSpawnList.TYROSH_MILITARY, 10).setSpawnChance(SPAWN));
