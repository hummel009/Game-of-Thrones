package io.github.hummel009.minecraft.got.common.world.structure.essos.dothraki;
...
import io.github.hummel009.minecraft.got.common.entity.animal.GOTEntityBird;
import io.github.hummel009.minecraft.got.common.entity.animal.GOTEntityButterfly;
import io.github.hummel009.minecraft.got.common.entity.essos.dothraki.GOTEntityDothrakiShaman;
...
public class GOTStructureDothrakiShamanTent extends GOTStructureDothrakiBase {
	private static final Class<? extends GOTStructureBase>[] STALLS = new Class[]{Mason.class, Brewer.class, Miner.class, Armourer.class};

	public GOTStructureDothrakiShamanTent(boolean flag) {
		super(flag);
	}
	...
	public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
		...
		placeAnimalJar(world, -4, 5, -1, GOTBlocks.birdCage, 2, new GOTEntityBird(world));
	...
	public static class Armourer extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, -1, 2, -2, 2, getRandWeaponItem(random));
			GOTEntityNPC trader = new GOTEntityDothrakiShaman(world);
	...
	public static class Mason extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, 1, 3, 1, 6, getRandWeaponItem(random));
			GOTEntityNPC trader = new GOTEntityDothrakiShaman(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
	...
	public static class Miner extends GOTStructureBase {
		...
		public boolean generate(World world, Random random, int i, int j, int k, int rotation) {
			...
			placeWeaponRack(world, 0, 2, 1, 6, getRandWeaponItem(random));
			GOTEntityNPC trader = new GOTEntityDothrakiShaman(world);
			spawnNPCAndSetHome(trader, world, 0, 1, 0, 4);
			return true;
		}
