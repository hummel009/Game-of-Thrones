package io.github.hummel009.minecraft.got.common.block.slab;
...
public class GOTBlockSlab11 extends GOTBlockSlabBase {
	public GOTBlockSlab11(boolean hidden) {
	...
	public IIcon getIcon(int i, int j) {
		...
		switch (j1) {
			case 0:
				return GOTBlocks.brick5.getIcon(i, 8);
			case 1:
				return GOTBlocks.brick5.getIcon(i, 9);
			case 2:
